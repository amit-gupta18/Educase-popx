            ...
            <div className='p-4 min-h-screen flex flex-col justify-between'>
                    ...
                    <div className="flex flex-col ">
                            ...
                            <div className="mt-8 mb-8 flex flex-col gap-2 w-full">
                                    <Link to="/register">
                                            <button className='bg-[#6c25ff] font-semibold text-white py-2 px-4 rounded-md w-full'>Create Account</button>
                                    </Link>
                                    <Link to="/login">
                                            <button className="bg-[#ceb9fa] font-semibold text-gray-900 py-2 px-4 rounded-md w-full">Already Registered? Login</button>
                                    </Link>
                            </div>
                    </div>
            </div>
